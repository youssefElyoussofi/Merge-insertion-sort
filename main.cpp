...
int main(int ac, char **av)
{
    ...
    try
    {
        ...
        time1 = merge.algo(VECTOR);
        // time2 = merge.algo(LIST);
        // merge.display();
        // cout << "Time to process a range of 5 elements with std::vector : " << time1 << " us\n";
        // cout << "Time to process a range of 5 elements with std::list : " << time2 << " us\n";
        cout << time1 << " us  ";
    }
